			...
			<div class="col-12">
				<div class="card">
			        ...
			        <div class="card-content">
			          	<div class="card-body">
			            	<div class="card-text">
			              		<form class="form" method="POST" action="{{ route('admin.snippet.update', [$snippet->id]) }}" novalidate>
			              		@csrf
			              		@method('PUT')
			              		<div class="form-body">
			                		<div class="row">
			                 			<div class="col-md-12 col-12">
						                    <div class="form-group">
						                      	...
						                      	<input type="text" id="name" class="form-control" required data-validation-required-message="Snippet Name field is required" value="{{ $snippet->name }}" name="name" placeholder="e.g Google Adwords">
						                ...
						                <div class="col-md-12 col-12">
					                    	<div class="form-group">
					                      		...
					                      		<select class="form-control" name="site_display" id="site_display" required data-validation-required-message="Site display field is required">
					                      			<option value="{{ $snippet->display }}">{{ ucwords($snippet->display) }}</option>
			                		...
			                		<div class="row {{ $snippet->display == 'page' ? 'd-block' : 'd-none' }}" id="page_section">
						                <div class="col-md-12 col-12">
					                    	<div class="form-group">
					                      		...
					                      		<select class="form-control" name="page" id="page" required data-validation-required-message="Page field is required">
					                      			<option value="{{ $snippet->page }}">{{ ucfirst($snippet->page) . ' Page' }}</option>
						                ...
						                <div class="col-md-12 col-12">
					                    	<div class="form-group">
					                      		...
					                      		<select class="form-control" name="location" required data-validation-required-message="Location field is required">
					                      			<option value="{{ $snippet->location }}">{{ ucfirst($snippet->location) }}</option>
						                ...
						                <div class="col-md-12 col-12">
					                    	<div class="form-group">
					                      		...
					                      		<select class="form-control" name="status" required data-validation-required-message="Status field is required">
					                      			<option value="1" {{ $snippet->is_active == 1 ? 'selected' : '' }}>Active</option>
					                      			<option value="0" {{ $snippet->is_active == 0 ? 'selected' : '' }}>Inactive</option>
					                      		</select>
					                      		<div class="help-block font-small-3"></div>
					                    	</div>
					                  	</div>
					                ...
					                <div class="row">
					                  	<div class="col-md-12 col-12">
					                    	<div class="form-group">
					                      		...
					                      		<textarea name="code" class="form-control" rows="10" required data-validation-required-message="Snippet / Code field is required">{{ $snippet->code }}</textarea>
					                     	 	<div class="help-block font-small-3"></div>
					                    	</div>
					                  	</div>
					                </div>
  ...
  <script>
  	$(document).ready(function() {
  		$("#site_display").on('change', function() {
  			...
  			if(display == 'page') {
  				$("#page_section").addClass('d-block');
  				$("#page_section").removeClass('d-none');
  			} else {
  				$("#page_section").removeClass('d-block');
