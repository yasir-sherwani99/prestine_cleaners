	        	...
	        	<div class="card-content">
	          		<div class="card-body">
	          			<div class="table-responsive">
	              			<table id="meta_table" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
	                			<thead>
				                  	<tr>
				                    	<th class="border-top-0 text-center">#</th>
				                    	<th class="border-top-0">Page</th>
				                    	<th class="border-top-0">Title</th>
				                    	<th class="border-top-0 text-left w-50">Description</th>
				                  	</tr>
	                			</thead>
	                			<tbody>
  	...
  	<script>
  		$(document).ready(function() {
  			$('#meta_table').DataTable({
		        ...
		        "sAjaxSource": "{{ url('admin_panel/getMetaTagsPages') }}",
