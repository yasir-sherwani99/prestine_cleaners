...
<div class="content-header row">
  	<div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
      	<h3 class="content-header-title mb-0 d-inline-block">Bookings List</h3>
    ...
    <div class="content-header-right col-md-4 col-12">
      	<a class="btn btn-danger box-shadow-2 btn-glow round btn-min-width pull-right" href="{{ route('admin.bookings.create') }}">Add New Booking</a>
    </div>
</div>
...
<div class="alert alert-icon-left alert-arrow-left alert-danger alert-dismissible mb-2" role="alert">
    ...
    <strong>Oh Snap!</strong> <span class="text-bold-600">{{ session()->get('error') }}</span>
</div>
<script>

    $(document).ready(function(){
        setTimeout(function(){ toastr.error("{{ session()->get('error') }}", 'Prestine System Says', {"hideDuration": 500, positionClass: 'toast-top-right'}); }, 2000);
    });
	        	...
	        	<div class="card-content">
	            	...
	            	<!-- Booking List table -->
	            		<div class="table-responsive">
	              			<table id="booking_table" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
		                		<thead>
			                  		<tr>
			                    		<th>#</th>
			                    		<th>Customer</th>
  	...
  	<script>
  		$(document).ready(function() {
  			$('#booking_table').DataTable({
		        ...
		        "sAjaxSource": "{{ url('admin_panel/getBookingList') }}",
