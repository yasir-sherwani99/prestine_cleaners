...
<div class="content-header row">
  	<div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
      	<h3 class="content-header-title mb-0 d-inline-block">Customers List</h3>
    ...
    <div class="content-header-right col-md-4 col-12">
      	<a class="btn btn-danger box-shadow-2 btn-glow round btn-min-width pull-right" href="{{ route('admin.customers.create') }}">Add New Customer</a>
    </div>
</div>
	        	...
	        	<div class="card-content">
	            	...
	            	<!-- Task List table -->
	            		<div class="table-responsive">
	              			<table id="customer_table" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
		                		<thead>
			                  		<tr>
			                    		<th>#</th>
			                    		<th>Customer</th>
  	...
  	<script>
  		$(document).ready(function() {
  			$('#customer_table').DataTable({
		        ...
		        "sAjaxSource": "{{ url('admin_panel/getCustomerList') }}",
