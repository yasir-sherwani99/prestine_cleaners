<div class="container service_details after_builders_details">
	<div class="row">
    	<div class="col-lg-12">
    		<h4 class="mb-5">After Builder's Service Details</h4>
	
			@include('front.booking.inc.sections.property_extra_types')

			@include('front.booking.inc.sections.property_things_2')
