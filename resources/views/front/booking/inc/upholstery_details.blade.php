<div class="container service_details upholstery_details">
	<div class="row">
    	<div class="col-lg-12">
    		<h4 class="mb-5">Upholstery Service Details</h4>

		    @include('front.booking.inc.sections.furniture')

		    @include('front.booking.inc.sections.furniture_material')

		    @include('front.booking.inc.sections.mattress')
