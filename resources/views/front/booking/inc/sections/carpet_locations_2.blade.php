<div class="choose_carpet_locations checkbox_error mb-4">
    <div class="row">
        <div class="col-md-12">
            <label for="post_code"><strong>What areas need carpet cleaning? <span class="mandatory">*</span></strong></label>
        </div>
    </div>
            ...
            <div class="col-md-2 ml-auto col-12 text-center">
                ...
                <script>
                    ...
                    $(".{{ 'carpet_' . strtolower($new_carpet_title) . '_qty' }}").on('change', function() {
                        ...
                        if("{{ $item->id }}" == 11) {
                            $("#carpet_bedroom_qty").text(qty);
                            $("#carpet_bedroom_total").text(total);
                        ...
                        if("{{ $item->id }}" == 12) {
                            $("#carpet_living_qty").text(qty);
                            $("#carpet_living_total").text(total);
                        ...
                        if("{{ $item->id }}" == 13) {
                            $("#carpet_dining_qty").text(qty);
                            $("#carpet_dining_total").text(total);
                        ...
                        if("{{ $item->id }}" == 14) {
                            $("#carpet_hallway_qty").text(qty);
                            $("#carpet_hallway_total").text(total);
                        ...
                        if("{{ $item->id }}" == 15) {
                            $("#carpet_staircase_qty").text(qty);
                            $("#carpet_staircase_total").text(total);
                        ...
                        if("{{ $item->id }}" == 16) {
                            $("#carpet_landing_qty").text(qty);
                            $("#carpet_landing_total").text(total);
